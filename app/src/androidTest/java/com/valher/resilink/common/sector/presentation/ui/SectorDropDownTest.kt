...
class SectorDropDownTest {
    ...
    fun setup() {
        ...
        viewModel = object : SectorViewModel(mockk(relaxed = true)) {
            override val isLoading = isLoadingFlow
            override val errorMessage = errorMessageFlow
            override val sectores = sectoresFlow
        }

    }

    private val mockSectores = listOf(
    ...
    private val sectoresFlow = MutableStateFlow(mockSectores)
    ...
    fun muestraProgressIndicatorCuandoLoadingEsTrue() {
        ...
        composeTestRule.setContent {
            SectorDropDown(viewModel = viewModel)
        }
    ...
    @Test
    fun muestraMensajeDeErrorCuandoEsNull() {
    ...
    @Test
    fun muestraDropdownMenuCuandoSectoresEstanCargados() {
